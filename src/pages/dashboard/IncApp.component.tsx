...
const ProfileCard = React.memo(
  ...
  return (
    <div className="shadow-sm border border-black/15 rounded-md flex-1 p-4 min-w-[280px] max-w-[350px]">
      {/* Why: Added min-w and max-w to ensure responsive card layout on smaller and larger screens without affecting existing styles */}
        ...
        <div className="flex items-center gap-3 mb-3">
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center gap-1 text-xs text-[#737373] mt-1">
              {/* Why: Fixed missing `#` in text-[#737373] for consistent text color */}
              {dateRange}
            </div>
          </div>
        </div>
...
const teamMembers = [
  // Why: DRY - Created a base object to reuse common properties
  {
...
const IncApp: React.FC = () => {
  return (
    <section>
      <div className="flex flex-col lg:flex-row justify-between gap-6 my-10">
        {/* Why: Added flex-col + lg:flex-row to make heading and buttons stack on small screens and align on large screens */}
        ...
        <div className="flex flex-wrap gap-4">
          {/* Why: Added flex-wrap to prevent buttons from overflowing on smaller devices */}
      ...
      <div className="flex flex-wrap gap-6 justify-center">
        {/* Why: Already using flex-wrap and justify-center for a responsive card grid layout */}
